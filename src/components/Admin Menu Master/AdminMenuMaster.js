...
import AdminMenuMasterForm from "./AdminMenuMasterForm";
import AdminMenuMasterTable from "./AdminMenuMasterTable";
...
function AdminMenuMaster() {
  ...
  const [adminMenuMaster, setAdminMenuMaster] = useState([]);
  ...
  const getAdminMenuMasters = async () => {
    try {
    ...
    <>
      <div>
        <div className="d-flex justify-content-end">
          ...
          >
            {hasAddAccess("Admin Menu Master") && (
              <button
                className="btn btn-info"
                onClick={() => setShowForm(true)}
              >
                Create Admin Menu Master
              </button>
            )}
          </div>
        </div>
        {showForm && (
          <AdminMenuMasterForm
            ...
            isEdit={isEdit}
            editId={editId}
            getAdminMenuMasters={getAdminMenuMasters}
...
export default AdminMenuMaster;
